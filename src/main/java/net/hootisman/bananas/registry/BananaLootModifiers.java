...
public class BananaLootModifiers {
    ...
    public static final RegistryObject<Codec<BananaLeavesLootModifier>> BANANA_LEAVES_LOOT_MODIFIER = LOOT_MODIFIERS.register("banana_leaves",() -> BananaLeavesLootModifier.CODEC);
